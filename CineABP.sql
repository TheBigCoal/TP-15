...
VALUES ('Gold'), ('Premium'), ('Com�n'), ('Plata'), ('Black');

INSERT INTO Usuarios (nombre, apellido, email, telefono, id_membresia)
VALUES
('Juan', 'G�mez', 'juan@gmail.com', '351222111', 1),
('Ana', 'Mart�nez', 'ana@gmail.com', '351999888', 2),
('Sara', 'P�rez', 'sara@gmail.com', '351111222', 3),
('Lucas', 'Rivas', 'lucas@gmail.com', '351333444', 4),
('Mario', 'L�pez', 'mario@gmail.com', '351555666', 5);

INSERT INTO Tipos_Comidas (nombre)
VALUES ('Bebida'), ('Snack'), ('Combo'), ('Dulces'), ('Comida R�pida');
